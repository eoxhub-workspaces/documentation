...
1\. Navigate to your EOxHub workspace, for example <https://gtif-austria.info/> and log into your account. If you need help doing so, or do not yet own an account, follow the link to find the tutorial covering how to create one: [How to create an account in EOxHub workspaces](https://scribehow.com/viewer/How_to_create_an_account_in_EOxHub_workspaces__Redd2vQITzy6xrpfV0qRSA)
