...
\
2\. Click "Headless Notebook" to verify that the application is enabled. If this icon is missing, please contact our support team or your Workspace administrator to have it enabled.
