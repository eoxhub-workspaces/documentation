...
![Example explorer](applications/assets/example_explorer.png)
...
1. Open the [example notebook collection](https://eoxhub-workspaces.github.io/eoxhub-notebooks/).
2. Choose a notebook you would like to explore.
3. Use the option provided on the notebook page to open it in your EOxHub Workspace (space rocket symbol 🚀 in the top corner).
4. Select your Workspace and start JupyterLab.
5. Run the notebook cells or adapt the example to your own data and use case.
...
- [View the source repository](https://github.com/eoxhub-workspaces/eoxhub-notebooks)
